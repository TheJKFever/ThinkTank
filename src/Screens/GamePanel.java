...
public class GamePanel extends JPanel {
	...
	private static final long serialVersionUID = 123783444588707640L; // not
																		// necessary
	...
	static int DISPLAY_TIME_X = Settings.BOARD_WIDTH / 2; // TODO: display time
															// exactly centered
	...
	public void drawHUD(Graphics g) {
		...
		g.drawString("Thoughts: " + player.tank.thoughts, THOUGHTS_X,
				THOUGHTS_Y);
	...
	public void drawMap(Graphics g) {
		...
		// black background
		g.fillRect(0, 0, Global.Settings.BOARD_WIDTH,
				Global.Settings.BOARD_HEIGHT);
	}
	...
	public void drawThoughtPools(Graphics g) {
		...
		for (ThoughtPool thoughtPool : gameState.thoughtPools) {
			...
			g.fillRect(thoughtPool.x, thoughtPool.y, thoughtPool.width,
					thoughtPool.height);
		}
	}
		...
		for (Entity e : entities) {
			...
			if (e.isDying()) {
				...
				if (e instanceof Shot) {
					...
					} else if (added.weapon instanceof Weapons.DoubleStrengthWeapon) {
